...
return fn(Renderer $renderer, string $odometer, string $speed, string $power) => $renderer->fragment(<<<HTML
 <p class="iconList">
            <span class="icon">
                <svg focusable="false" data-prefix="fas" data-icon="route" role="img"
                ...
                <span>{$renderer->render($odometer)}</span>
            </span>
            <span class="icon">
                ...
                <span>{$renderer->render($speed)}</span>
            </span>
            <span class="icon">
                ...
                <span>{$renderer->render($power)}</span>
            </span>
     </p>
HTML
);